...
const handle=async request=>{
  ...
  try{
    if(url.pathname==='/api/me'||url.pathname==='/api/lab/me'||url.pathname==='/api/prospect/me')return Response.json(user,{headers});
