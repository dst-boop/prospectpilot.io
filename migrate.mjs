...
export async function migrate(pool){
 ...
 try{
  ...
  for(const [id,file] of [['001','generated/schema.sql'],['002','migrations/002-query-indexes.sql'],['003','migrations/003-linkedin.sql'],['004','migrations/004-research-jobs.sql'],['005','migrations/005-research-history-index.sql'],['006','migrations/006-research-lab.sql'],['007','migrations/007-quality-v2.sql'],['008','migrations/008-prospect-workspace.sql'],['009','migrations/009-prospect-jobs.sql'],['010','migrations/010-plan-latest-filing.sql'],['011','migrations/011-email-domain-check.sql']]){
