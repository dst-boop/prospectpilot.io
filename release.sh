...
if version.get('advisor_workspace_version')!='advisor-workflow-1' or version.get('cadence_version')!='outreach-cadence-1' or version.get('feature_set')!='research-lab-v1' or version.get('quality_version')!='retirement-evidence-2' or version.get('contact_workspace_version')!='professional-contacts-1' or version.get('release_id')!=sys.argv[1]:
