...
test('PostgreSQL serializes a new review behind an in-flight assessment',{
 ...
 try{
  ...
  for(const file of ['generated/schema.sql','migrations/006-research-lab.sql','migrations/007-quality-v2.sql','migrations/012-plan-catalog-summary.sql','migrations/008-prospect-workspace.sql','migrations/013-advisor-workflow.sql','migrations/014-outreach-cadence.sql', 'migrations/015-dial-budget.sql', 'migrations/016-inbound-contact.sql'])await pool.query(readFileSync(new URL('../'+file,import.meta.url),'utf8'));
