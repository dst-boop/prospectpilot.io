...
function client(){
 ...
 for(const id of ['contactTitle','contactBody','contactError','toggleSuppression','closeContact','correctionForm','conflictReason0','contactHistory','contactHistoryBody','editContact','reviewContactConflicts','contactConflicts','correctionPanel','firstField'])create(id);
